...
public:
  ...
  signaling_server( io_context &io_ctx, deadline_timer &d_timer, ice_agent::ice_sender& ice_sender, direct_routing_table_controller &d_routing_table_controller, ice_observer_strage *obs_strage );
